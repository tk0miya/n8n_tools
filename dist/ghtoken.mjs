...
// src/github/tokenExpiry.ts
async function fetchTokenExpiry(client) {
...
function toCheckTokenResult(expiration) {
  if (!expiration) {
...
function computeDaysUntilExpiry(expiration, now = /* @__PURE__ */ new Date()) {
